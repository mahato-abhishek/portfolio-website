  ...
  return (
    <>
      <div className=" min-h-screen scroll-smooth flex items-center justify-center flex-col pt-16">
        ...
        >
          <div className="h-16 border-b dark:border-gray-700  border-gray-400 w-full grid grid-cols-8">
          ...
          <div className="h-16 border-t dark:border-gray-700  border-gray-400  w-full grid grid-cols-8">
            <div className=" h-full"></div>
            <div className="border-l dark:border-gray-700  border-gray-400 h-full"></div>
            <div className="border-l dark:border-gray-700  border-gray-400 h-full"></div>
            <div className="border-l dark:border-gray-700  border-gray-400 h-full"></div>
